...
class AnalyzerServiceStub(object):
    ...
    def __init__(self, channel):
        ...
        self.AnalyzeCode = channel.unary_unary(
                '/analyzer.AnalyzerService/AnalyzeCode',
                request_serializer=analyzer__pb2.AnalyzeCodeRequest.SerializeToString,
                response_deserializer=analyzer__pb2.StatusResponse.FromString,
...
def add_AnalyzerServiceServicer_to_server(servicer, server):
    rpc_method_handlers = {
            'AnalyzeCode': grpc.unary_unary_rpc_method_handler(
                    ...
                    request_deserializer=analyzer__pb2.AnalyzeCodeRequest.FromString,
                    response_serializer=analyzer__pb2.StatusResponse.SerializeToString,
            ),
    }
...
class AnalyzerService(object):
    ...
    def AnalyzeCode(request,
        ...
        return grpc.experimental.unary_unary(
            ...
            target,
            '/analyzer.AnalyzerService/AnalyzeCode',
            analyzer__pb2.AnalyzeCodeRequest.SerializeToString,
            analyzer__pb2.StatusResponse.FromString,
            options,
            channel_credentials,
            insecure,
            call_credentials,
