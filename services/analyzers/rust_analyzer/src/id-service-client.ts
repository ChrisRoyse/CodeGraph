/**
 * ID Service Client for the Rust Analyzer
 *
...
export class IdServiceClient {
   ...
   * @param entityType Type of entity (Struct, Enum, Trait, Function, etc.)
   * @param name Name of the entity
   * @param parentCanonicalId Canonical ID of the parent entity (optional)
   * @param paramTypes Parameter types (optional)
   * @param languageHint Language hint to help with ID generation (optional, defaults to "rust")
