/**
 * ID Service Client for the SQL Analyzer
 *
...
export class IdServiceClient {
   ...
   * @param entityType Type of entity (Table, Column, View, etc.)
   * @param name Name of the entity
   * @param parentCanonicalId Canonical ID of the parent entity (optional)
   * @param paramTypes Parameter types for functions/procedures (optional)
